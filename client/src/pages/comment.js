...
export default function Signup() {
  return (
    ...
    <div class="top-buzz-container bg-yellow-200">
      ...
      <div class= "buzz-text-view  border-solid border-2 border-indigo-600">
        <p class= "buzz-text text-center md:font-serif tracking-wide bg-black text-white">I saw Sophia crying at the bar</p> <br></br>
        <p class= "buzz-details-text text-center md:font-serif text-white bg-black"> 📍Austin, TX </p></div><br></br>

      <br></br>

      <div class= "buzz-text-view  border-solid border-2 border-indigo-600">
        <p class= "buzz-text text-center md:font-serif tracking-wide text-white bg-black">I saw Sophia crying at the bar</p><br></br>
      <p class= "buzz-details-text text-center md:font-serif text-white bg-black">📍Austin, TX </p></div><br></br>
      </div>
